      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-14 sm:py-24 grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
        <div>
          ...
          <p className="fade-up fade-up-delay-2 mt-5 sm:mt-6 text-base sm:text-lg text-ink-700 dark:text-paper-200/70 leading-relaxed max-w-lg">
            GhostPay lets you send confidential payments from your existing
            Ethereum wallet using iExec Nox. Recipient addresses remain public
            while payment amounts and categories stay encrypted until you choose
            to reveal them.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-xs font-medium">
            <span className="rounded-full border border-brass-500/30 bg-brass-500/10 px-3 py-1.5 text-brass-600 dark:text-brass-400">
              Existing Wallets
            </span>
          ...
          <div className="fade-up fade-up-delay-3 mt-10 flex flex-wrap gap-x-6 gap-y-2 text-xs font-mono text-ink-700/60 dark:text-paper-200/50">
            <span>
              Wrapper
              <span className="ml-1 text-ink-950 dark:text-paper-50">
                GhostVault
              </span>
            </span>
        ...
        <div
          className="fade-up fade-up-delay-2 rounded-xl border border-ink-700/15 dark:border-paper-200/15 bg-paper-50 dark:bg-ink-900 shadow-sm overflow-hidden"
          onMouseEnter={() => setRevealed(true)}
          onMouseLeave={() => setRevealed(false)}
        >
          <div className="flex items-center justify-between px-5 py-3 border-b border-ink-700/10 dark:border-paper-200/10">
            <span className="text-xs font-mono text-ink-700 dark:text-paper-200/60">
              payment · preview
            </span>
            <span className="rounded-full border border-brass-500/40 px-2 py-0.5 text-[10px] font-mono text-brass-600 dark:text-brass-400">
              DRAFT
            </span>
          </div>
          <div className="divide-y divide-ink-700/10 dark:divide-paper-200/10 text-sm">
            <div className="flex items-center justify-between px-5 py-4">
              <span className="text-ink-700 dark:text-paper-200/60">
                Recipient
              </span>
              <span className="font-mono text-ink-950 dark:text-paper-50">
                0x7Bd4…41aA
              </span>
            </div>
            ...
            <div className="flex items-center justify-between px-5 py-4">
              ...
              {revealed ? (
                <span className="stamp-reveal font-mono text-brass-500 dark:text-brass-400 font-medium">
                  Freelance
                </span>
              ) : (
                <span className="redacted-bar rounded px-2 py-0.5 font-mono text-xs">
                  ••••••
                </span>
              )}
            </div>
          ...
          <div className="px-5 py-3 text-[11px] font-mono text-ink-700/50 dark:text-paper-200/40 border-t border-ink-700/10 dark:border-paper-200/10">
            Visible only to approved viewers through iExec Nox confidential execution.
          </div>
        </div>
      </div>
    </section>
